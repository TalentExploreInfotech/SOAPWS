 ...
 * 
 */
@WebServiceClient(name = "BookImplService", targetNamespace = "http://persistent.com/", wsdlLocation = "http://localhost:8080/SoapNewProvider/sayhello?WSDL")
    ...
    extends Service
{
    ...
    private final static QName BOOKIMPLSERVICE_QNAME = new QName("http://persistent.com/", "BookImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/SoapNewProvider/sayhello?WSDL");
    ...
    public BookImpl getBookImplPort() {
        return super.getPort(new QName("http://persistent.com/", "BookImplPort"), BookImpl.class);
    }
     ...
     */
    @WebEndpoint(name = "BookImplPort")
    public BookImpl getBookImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://persistent.com/", "BookImplPort"), BookImpl.class, features);
    }
